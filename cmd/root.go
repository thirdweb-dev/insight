...
func init() {
	...
	rootCmd.PersistentFlags().Int("committer-until-block", 0, "Until which block to commit")
	...
	viper.BindPFlag("committer.untilBlock", rootCmd.PersistentFlags().Lookup("committer-until-block"))
